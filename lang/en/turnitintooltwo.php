...
$string['turnitinsettingscourseexpiry'] = 'Expiry setting when creating Turnitin courses';
$string['turnitinsettingscourseexpiry_desc'] = '<strong>[Optional]</strong><br/>When creating a Turnitin course, what should the expiry date of the course be set to?<br/>Accepts any PHP strtotime() relative date format (see: http://php.net/manual/en/datetime.formats.relative.php). This is intended for scenarios where you can set an end of school year date without a year, and have it apply without needing to change each year.<br/>Also accepts "upcoming", which translates to "next year" if the date has already passed, or no change if the date is today or in the future.<br/>Eg: assume today\'s date is <em>1 July 2017</em> and a course is created today:<br /><ul><li>if setting is <em>30 June</em> - course will expire on 30 June 2017</li><li>if setting is <em>30 June upcoming</em> - course will expire on 30 June 2018</li><li>if setting is <em>31 July upcoming</em> - course will expire on 31 July 2017</li><li>if setting is <em>+3 months</em> - course will expire on 1 October 2017</li></ul>If left blank (default), the Turnitin API default expiry will apply - this is currently 6 months after creation.';
